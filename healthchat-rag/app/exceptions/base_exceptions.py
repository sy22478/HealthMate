...
class ErrorCode(Enum):
    ...
    DATABASE_BACKUP_ERROR = 4005
    DATABASE_RESTORE_ERROR = 4006
    DATABASE_FAILOVER_ERROR = 4007
    ...
    STORAGE_SERVICE_ERROR = 5005
    API_RESPONSE_ERROR = 5006
    INFRASTRUCTURE_ERROR = 5009
